...
object FixSplashScreen : Feature(
    ...
    override fun onLoadPackage() {
        ...
        val iconSizeChannel = Channel<Int?>(Channel.Factory.BUFFERED)
        val iconDefaultSizeChannel = Channel<Int?>(Channel.Factory.BUFFERED)
        val activityInfoChannel = Channel<ActivityInfo?>(Channel.Factory.BUFFERED)
